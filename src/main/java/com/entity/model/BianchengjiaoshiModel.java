 ...
 */
public class BianchengjiaoshiModel  implements Serializable {
	...
	public void setJiaoxuejingyan(String jiaoxuejingyan) {
		this.jiaoxuejingyan = jiaoxuejingyan;
	}
	
	/**
	 * 获取：教学经验
	 */
	public String getJiaoxuejingyan() {
		return jiaoxuejingyan;
	}
