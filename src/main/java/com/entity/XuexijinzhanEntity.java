...
public class XuexijinzhanEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public XuexijinzhanEntity() {
		
	}
	
	public XuexijinzhanEntity(T t) {
		try {
	 ...
	 * 设置：学习进展
	 */
	public void setXuexijinzhan(String xuexijinzhan) {
		this.xuexijinzhan = xuexijinzhan;
	}
	/**
	 * 获取：学习进展
	 */
	public String getXuexijinzhan() {
		return xuexijinzhan;
	}
