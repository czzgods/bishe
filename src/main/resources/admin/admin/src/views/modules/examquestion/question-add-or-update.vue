<template>
	<div :style='{"width":"100%","padding":"20px 40px","fontSize":"15px"}'>
		<el-form
			...
			label-width="180px"
		>
			<el-form-item :style='{"border":"0px solid #eee","width":"49%","padding":"0","margin":"0 0 26px 0","display":"inline-block"}' label="选择编程试卷" prop="paperid">
				<el-select @change="onPaperChange" v-model="ruleForm.paperid" placeholder="选择编程试卷">
					<el-option
			...
			<el-form-item :style='{"padding":"0","margin":"20px 0 0"}'>
				<el-button class="btn3" :style='{"border":"0px solid #ccc","cursor":"pointer","padding":"0 10px","margin":"0 10px 0 0","color":"#fff","borderRadius":"4px","background":"#32c67a","width":"auto","fontSize":"16px","minWidth":"110px","height":"40px"}' type="success" @click="onSubmit">
					<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","display":"none","height":"40px"}'></span>
					确定
				</el-button>
				<el-button class="btn4" :style='{"border":"0px solid #ccc","cursor":"pointer","padding":"0 10px","margin":"0 10px 0 0","color":"#fff","borderRadius":"4px","background":"#98a58f","width":"auto","fontSize":"16px","minWidth":"110px","height":"40px"}' type="success" @click="back()">
					<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","display":"none","height":"40px"}'></span>
					取消
				</el-button>
			</el-form-item>
	...
	export default {
		data() {
			...
			return {
				...
				rules: {
					paperid: [{ required: true, message: "请选择编程试卷", trigger: "blur" }],
					questionname: [
