	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-else-if="ruleForm.jiazhangzhanghao" label="家长账号" prop="jiazhangzhanghao" >
				...
				<el-form-item class="input" v-if="type!='info'"  label="家长电话" prop="jiazhangdianhua" >
					<el-input v-model="ruleForm.jiazhangdianhua" placeholder="家长电话" clearable  :readonly="ro.jiazhangdianhua"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="家长电话" prop="jiazhangdianhua" >
					<el-input v-model="ruleForm.jiazhangdianhua" placeholder="家长电话" readonly></el-input>
				</el-form-item>
