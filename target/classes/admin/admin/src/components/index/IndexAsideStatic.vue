	...
	mounted() {
		...
		this.$http({
			...
			if (data && data.code === 0) {
				...
				if(sessionTable == 'bianchengjiaoshi') {
					this.avatar = data.data.touxiang
				}
