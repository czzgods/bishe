<template>
	<div class="main-content" :style='{"width":"100%","padding":"20px 40px","fontSize":"15px"}'>
		<!-- 列表页 -->
		<div v-if="!showFlag">
			<el-form :style='{"padding":"40px 30px","borderColor":"#eee","borderRadius":"10px","borderStyle":"solid","borderWidth":"0px 0 0","background":"#fff"}' :inline="true" :model="searchForm" class="add-update-preview">
				<el-form-item :style='{"border":"0px solid #eee","width":"49%","padding":"0","margin":"0 0 26px 0","display":"inline-block"}' label="编程试卷">
