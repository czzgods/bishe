	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="upload" v-if="type!='info'&& !ro.fujian" label="附件" prop="fujian" >
					<file-upload
						tip="点击上传附件"
						action="file/upload"
						:limit="1"
				...
				<el-form-item v-else-if="ruleForm.fujian" label="附件" prop="fujian" >
					<el-button class="downBtn" type="text" size="small" @click="download($base.url+ruleForm.fujian)">
			...
			<el-form-item v-else-if="ruleForm.zhengwen" label="正文" prop="zhengwen" >
				<span class="text" v-html="ruleForm.zhengwen"></span>
			</el-form-item>
			...
			info(id) {
				this.$http({
					...
					if (data && data.code === 0) {
						...
						this.ruleForm.zhengwen = this.ruleForm.zhengwen.replace(reg,'../../../springboot798884g4/upload');
					} else {
						this.$message.error(data.msg);
					}
				});
